...
class FPLEnv:
    def __init__(self, agents: list[BaseAgent], season_df: pd.DataFrame, reward_type=constants.RewardType.TOTAL_TEAM_POINTS):
        self.gw = 1
    ...
    def run_simulation(self):
        ...
        while not done:
            ...
            observation, reward_n, done = self.step(teams=[agent.team for agent in self.agent_n])
    ...
    def get_observation_space(self, gw) -> tuple:
        gw_df = self.season_df[self.season_df[constants.NumericalFeatures.GAME_WEEK] == gw]
